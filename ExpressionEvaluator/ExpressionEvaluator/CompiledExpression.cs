...
namespace ExpressionEvaluator
{
    ...
    public class CompiledExpression : ExpressionCompiler
    {
        ...
        public TDelegete Compile<TDelegete>()
        {
            if (Expression == null) Expression = BuildTree();
            //var xx = Expression.Convert(Expression, typeof(object));
            return Expression.Lambda<TDelegete>(Expression, Parser.Parameters).Compile();
        }
